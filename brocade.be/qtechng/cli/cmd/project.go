...
func init() {
	...
	projectCmd.PersistentFlags().StringArrayVar(&Fnature, "nature", []string{}, "QtechNG nature of file")
	projectCmd.PersistentFlags().StringArrayVar(&Fcu, "cuser", []string{}, "UID of creator")
	projectCmd.PersistentFlags().StringArrayVar(&Fmu, "muser", []string{}, "UID of last modifier")
