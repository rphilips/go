...
func init() {
	...
	sourceCmd.PersistentFlags().StringArrayVar(&Fnature, "nature", []string{}, "QtechNG nature of file")
	sourceCmd.PersistentFlags().StringArrayVar(&Fcu, "cuser", []string{}, "UID of creator")
	sourceCmd.PersistentFlags().StringArrayVar(&Fmu, "muser", []string{}, "UID of last modifier")
	...
	sourceCmd.PersistentFlags().StringArrayVar(&Fneedle, "needle", []string{}, "Find substring")
	sourceCmd.PersistentFlags().StringArrayVar(&Fqpattern, "qpattern", []string{}, "Posix glob pattern on qpaths")
