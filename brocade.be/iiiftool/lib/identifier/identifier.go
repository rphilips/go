...
func CalculateIdentifier(
	...
	// - de identifier is de hexadecimale lowercase SHA-1 van deze nieuwe string
	...
	identifier := util.GetSHA1([]byte(result))

	return filesHash, identifier, nil
}
