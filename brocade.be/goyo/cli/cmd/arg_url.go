...
var argURLCmd = &cobra.Command{
	Use:   "url",
	Short: "Start goyo with arguments retrieved by URL",
	Long: `Launches goyo with the arguments retrieved by URL.
...
If the input *IS* a JSON array, the following applies:
	...
	Example: `goyo arg url https://dev.anet.be/about.html`,
	RunE:    argURL,
}
